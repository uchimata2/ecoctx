...
| `references/measure.md` | 22,070 | steps 1 to 5 only |
| `references/judge.md` | 25,017 | steps 6 to 11 only |
...
possible single-phase cost is 5,260 plus 25,017, or 30,277 bytes, and the common case is smaller.
